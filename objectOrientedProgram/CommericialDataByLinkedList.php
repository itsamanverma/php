 ...
 ******************/
        ...
        */
         ...
         */
         ...
         $amnt = validInt(Utility::getInteger(), 0, 90000);
         ...
         */
         function sell($stockacc)
          ...
          $ch = validInt(Utility::getInteger(), 1, count($account));
          echo $account[$ch - 1]->name . " selected!\nEnter Number Of Shares To Sell of " . $account[$ch - 1]->name . " : ";
          $qt = validInt(Utility::getInteger(), 1, $account[$ch - 1]->quantity);
          /* removing the stock */
          ...
          */
          ...
          echo "Enter 4 to see Transaction History\n";
