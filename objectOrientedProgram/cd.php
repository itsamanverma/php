include('Utility.php');
   ...
   /**
    ...
    //var_dump($account);
     /* list of var store in the list the stock to purachase from */
    $list = printStockList();
     /* askins use for in */
    ...
    echo $list[$ch - 1]->name . " selected!\nEnter No Of Shares To Buy of " . $list[$ch - 1]->name . " : ";
     /* amnt to store the no of share to buy */
    $amnt = Utility::validInt(Utility::getInteger(), 0, 90000);
     ...
     */
     ...
     $qt = Utility::validInt(Utility::getInteger(), 1, $account[$ch - 1]->quantity);
     /* removing the stock */
