<?php
/**
 * create the Implementation class of Computer, named as ServerImpl
 * and Override all the Abstract methods of Computer class
 * @author  : AMAN VERMA
 * @version : 1.0
 * @date    : 15/02/2019
 */
class ServerImpl implements IComputer
{
    /*take the three private member function of ServerImpl(implementation class) */
    private $ram;
    private $hdd;
    private $cpu;
